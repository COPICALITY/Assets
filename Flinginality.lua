...
if validPlace then
    ...
    if isHeartbeat() then
        ...
        -- gui library
        local libstring
        for _,v in pairs({'https://raw.githubusercontent.com/COPICALITY/Assets/refs/heads/main/rayfield.lua"))()', "https://sirius.menu/rayfield"}) do -- the backup wont actually work since Cube-07 uses a custom version of rayfield
            if pcall(function()
